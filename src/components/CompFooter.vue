...
<h5 class="widget-title">MEME APP<span></span></h5>
...
<h5 class="widget-title">Sản phẩm<span></span></h5>
<ul class="thumbnail-widget">
<li>
<div class="thumb-content"><a href="#.">Trí tuệ nhân tạo</a></div>	
</li>
<li>
<div class="thumb-content"><a href="#.">Thực tế ảo</a></div>	
</li>
<li>
<div class="thumb-content"><a href="#.">Công cụ tăng cường</a></div>	
</li>
<li>
<div class="thumb-content"><a href="#.">Lĩnh vực game</a></div>	
</li>
<li>
<div class="thumb-content"><a href="#.">Điện toán đám mây</a></div>	
</li>
<li>
<div class="thumb-content"><a href="#.">Công cụ đăng</a></div>	
</li>
<li>
<div class="thumb-content"><a href="#.">AWS</a></div>	
</li>
</ul>
</div>
</div>
...
<div class="col-xs-12 col-sm-6 col-md-3">
<div class="widget no-box">
<h5 class="widget-title">Chương trình<span></span></h5>
<p>Vì một hệ sinh thái vững mạnh</p>
<a class="btn" href="#" target="_blank">Đăng ký ngay</a>
</div>
</div>
...
<div class="widget no-box">
<h5 class="widget-title">Tin tức<span></span></h5>

<p>Email : <a href="mailto:info@domain.com" title="glorthemes">tranphuocluan196@gmail.com</a></p>
...
<p>Copyright by PhuocLuan © 2020</p>
</div>
</div>
</div>
</div>
...
/* Main Footer */
footer .main-footer{	padding: 20px 0;	background: peru;}
